...
public class CustomerLoanInformationServiceImp implements ICustomerLoanInformationService {
	...
	@Autowired
	public CustomerLoanInformationServiceImp(CustomerLoanInformationRepository customerLoanInformationRepository) {
		super();
		this.customerLoanInformationRepository = customerLoanInformationRepository;
	}
